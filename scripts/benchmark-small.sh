...
# Benchmark on a medium-sized public repo (yt-dlp)
...
# Resolve repository root from this script's location before changing directories
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
TARGET_DIR="$(cd "${SCRIPT_DIR}/.." && pwd)"

echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}        ocloc vs cloc — Medium Repo Benchmark (yt-dlp)     ${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"

WORKDIR="$(mktemp -d -t ocloc-bench-small-XXXXXX)"
cleanup() {
...
# Helpers to time commands using bash time builtin
measure_time() {
...
parse_ocloc_totals() {
  # Extract numeric columns from the Total row
  local s="$1"
  local line
  ...
  # numbers: files blank comment code total
  local nums
